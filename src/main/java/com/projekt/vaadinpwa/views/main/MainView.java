package com.projekt.vaadinpwa.views.main;
...
import com.projekt.vaadinpwa.views.startview.StartViewView;
import com.projekt.vaadinpwa.views.users.UsersView;

/**
 * The main view is a top-level placeholder for other views.
 */
@JsModule("./styles/shared-styles.js")
@PWA(name = "VaadinPWA", shortName = "VaadinPWA")
...
public class MainView extends AppLayout {
    ...
    private static Tab[] getAvailableTabs() {
        ...
        tabs.add(createTab("StartView", StartViewView.class));
